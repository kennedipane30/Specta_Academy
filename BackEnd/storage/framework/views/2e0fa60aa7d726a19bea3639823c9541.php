        ...
        <form action="<?php echo e(route('admin.manajemen-pengajar.update', $teacher->usersID)); ?>" method="POST" class="teacher-form" id="editForm">
            ...
            <div class="input-group">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name', $teacher->name)); ?>" required>
                </div>
            ...
            <div class="input-group">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" value="<?php echo e(old('email', $teacher->email)); ?>" required>
                </div>
            </div>
            ...
            <div class="input-group">
                ...
                <div>
                    ...
                    <input type="text" name="phone" id="phone" value="<?php echo e(old('phone', $teacher->phone)); ?>" required>
                </div>
