...
<div class="cp-page">
    ...
    <section class="cp-header">
        <div class="cp-header-left">
            ...
            <h1>Kelola Materi: <span style="color: var(--spekta-teal);"><?php echo e($subject_name); ?></span></h1>
            <p>Kelas: <?php echo e($class->program_name ?? 'N/A'); ?> • Pilih minggu, isi judul, dan unggah modul pembelajaran.</p>
        </div>
        <div class="cp-header-actions">
            <a href="<?php echo e(route('pengajar.materi.index')); ?>" class="cp-secondary-btn">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-group">
                                ...
                                <form method="POST" action="<?php echo e(route('pengajar.materi.destroy', $item['material_id'] ?? 0)); ?>" onsubmit="return confirm('Hapus materi ini? Data di aplikasi peserta didik juga akan terhapus.')" style="margin: 0; display: inline-flex;">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.spekta', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\perkuliahan\PA 2 - code\PAAAAA2\BackEnd\resources\views/pengajar/materi/pilih.blade.php ENDPATH**/ ?>