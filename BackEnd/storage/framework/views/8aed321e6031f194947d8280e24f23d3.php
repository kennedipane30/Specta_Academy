...
<div class="bn-page">
    ...
    <section class="bn-stats">
        <div class="bn-stat-card">
            ...
            <p>Total Banner</p>
            <h2><?php echo e(number_format($banners->total() ?? $banners->count())); ?></h2>
        ...
        <div class="bn-stat-card">
            ...
            <p>Banner Aktif</p>
            <h2><?php echo e(number_format($banners->where('is_active', true)->count())); ?></h2>
            <div class="bn-stat-meta">
        ...
        <div class="bn-stat-card">
            ...
            <p>Banner Nonaktif</p>
            <h2><?php echo e(number_format($banners->where('is_active', false)->count())); ?></h2>
            <div class="bn-stat-meta">
        ...
        <div class="bn-stat-card">
            ...
            <h2><?php echo e(number_format($banners->max('order_position') ?? 0)); ?></h2>
            <div class="bn-stat-meta">
    ...
    <section class="bn-main-grid">
        ...
        <div class="bn-list-panel">
            <div class="bn-panel-heading">
                ...
                <a href="<?php echo e(route('admin.banners.create')); ?>" class="bn-small-action">
                    <i class="fa-solid fa-plus"></i>
                    Tambah
                </a>
            </div>
            ...
            <div class="bn-banner-list">
                    ...
                    <article class="bn-banner-card">
                        ...
                        <div class="bn-banner-content">
                            ...
                            <div class="bn-meta-grid">
                                <div>
                                    <span>Link</span>
                                    <strong><?php echo e($banner->link ?: '-'); ?></strong>
                                </div>
                            ...
                            <div class="bn-actions">
                                ...
                                <form action="<?php echo e(route('admin.banners.destroy', $banner)); ?>" method="POST" onsubmit="return confirm('Hapus banner ini?')">
                                    <?php echo csrf_field(); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="bn-empty">
                        ...
                        <a href="<?php echo e(route('admin.banners.create')); ?>">Tambah Banner Pertama</a>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="bn-side-card">
                ...
                <div class="bn-summary-list">
                    <div>
                        ...
                        <strong><?php echo e(number_format($banners->total() ?? $banners->count())); ?></strong>
                    </div>

                    <div>
                        <span><i class="dot green"></i>Banner Aktif</span>
                        <strong><?php echo e(number_format($banners->where('is_active', true)->count())); ?></strong>
                    </div>

                    <div>
                        <span><i class="dot gray"></i>Banner Nonaktif</span>
                        <strong><?php echo e(number_format($banners->where('is_active', false)->count())); ?></strong>
                    </div>

                    <div>
                        <span><i class="dot blue"></i>Urutan Tertinggi</span>
                        <strong><?php echo e(number_format($banners->max('order_position') ?? 0)); ?></strong>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.spekta', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Windows\Documents\GitHub\Specta_Academy\BackEnd\resources\views/admin/banners/index.blade.php ENDPATH**/ ?>