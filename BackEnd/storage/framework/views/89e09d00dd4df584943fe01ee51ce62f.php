                ...
                <nav class="sidebar-nav">
                    <?php if(Auth::check() && Auth::user()->role_id == 1): ?>
                        ...
                        <div class="nav-section">
                            ...
                            <a href="<?php echo e(route('admin.siswa.pendaftaran')); ?>" class="sidebar-item <?php echo e(request()->routeIs('admin.siswa.pendaftaran') ? 'is-active' : ''); ?>">
                                <i class="fa-solid fa-circle-check"></i> <span>Konfirmasi Kelas</span>
                                <?php if(($layoutPendingEnrollment ?? 0) > 0): ?>
                                    <em class="nav-badge"><?php echo e($layoutPendingEnrollment); ?></em>
                                <?php endif; ?>
                            </a>
...
</html><?php /**PATH D:\Perkuliahan\SEMESTER 4\PA ll\Specta_Academy\BackEnd\resources\views/layouts/spekta.blade.php ENDPATH**/ ?>