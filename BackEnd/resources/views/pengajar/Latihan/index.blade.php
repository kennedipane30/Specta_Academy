...
@section('title', 'Pilih Kelas - Latihan Soal')

@section('content')
<div class="bg-white p-8 rounded-3xl shadow-md border-t-8 border-[#990000]">
    <div class="mb-8">
        <h3 class="text-2xl font-black uppercase text-gray-800 tracking-tight">Pilih Program Latihan</h3>
        <p class="text-sm text-gray-500 font-medium">Silakan pilih kelas untuk mengelola bank soal latihan (CSV).</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($classes as $c)
            <div class="group relative bg-gray-50 rounded-3xl border border-gray-100 overflow-hidden hover:shadow-2xl transition duration-500">
                <div class="h-32 bg-[#990000] relative overflow-hidden">
                    ...
                    <div class="p-6">
                        <span class="bg-white/20 text-white text-[10px] font-black px-3 py-1 rounded-full uppercase">Program Spekta</span>
                    </div>
                </div>
                ...
                <div class="p-6">
                    ...
                    <a href="{{ route('pengajar.latihan.pilih', $c->class_modelsID) }}"
        ...
        @empty
            {{-- Bagian ini yang sebelumnya salah ketik --}}
            <div class="col-span-full text-center py-20 text-gray-400 italic font-bold uppercase tracking-widest">
