...
<div class="dt-page">
    ...
    <section class="dt-hero">
        <div class="dt-hero-content">
            ...
            <div class="dt-hero-tags">
                <span class="tag-pending"><i class="fa-solid fa-clock"></i> {{ $pendingRequests }} Pending</span>
                <span class="tag-confirmed"><i class="fa-solid fa-circle-check"></i> {{ $confirmedRequests }} Confirmed</span>
                <span class="tag-today"><i class="fa-solid fa-calendar-day"></i> {{ $todayRequests }} Hari Ini</span>
            </div>
        </div>
    ...
    <section class="dt-summary">
        <div class="summary-card">
            <span>Total</span>
            <strong class="text-dark">{{ $totalRequests }}</strong>
        </div>
        <div class="summary-card">
            <span>Pending</span>
            <strong class="text-warning">{{ $pendingRequests }}</strong>
        </div>
        <div class="summary-card">
            <span>Confirmed</span>
            <strong class="text-success">{{ $confirmedRequests }}</strong>
        </div>
        <div class="summary-card">
            <span>Rejected</span>
            <strong class="text-danger">{{ $rejectedRequests }}</strong>
        </div>
    </section>
            ...
            @forelse($tutors as $t)
                ...
                <article class="dt-card {{ $t->status }}">
                    ...
                    <div class="dt-card-info">
                        <div class="dt-avatar">{{ strtoupper(substr($studentName, 0, 1)) }}</div>
                        <div class="dt-details">
                            <div class="dt-head">
                                <h3>{{ $studentName }}</h3>
                                <span class="dt-badge {{ $t->status }}">{{ strtoupper($t->status) }}</span>
                            </div>
                            ...
                            <div class="dt-meta-row">
                                ...
                                <div class="meta-item">
                                    ...
                                    <strong>{{ $t->teacher->name ?? 'Belum Ditugaskan' }}</strong>
                                </div>
                            </div>
                        </div>
                    </div>

                    {{-- Kanan: Aksi / Status Akhir --}}
