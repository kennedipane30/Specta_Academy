...
<div class="space-y-8">
    ...
    <div class="bg-white p-8 rounded-[2rem] shadow-sm border-t-8 border-[#990000]">
        <h3 class="text-2xl font-black text-gray-800 uppercase tracking-tight mb-2">Tambah Akun Pengajar</h3>
        <p class="text-xs text-gray-400 font-bold uppercase tracking-widest mb-8">Daftarkan tenaga pendidik baru untuk portal Spekta</p>
        ...
        <form action="{{ route('admin.manajemen-pengajar.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-4 gap-4 bg-gray-50 p-6 rounded-3xl border border-gray-100 shadow-inner">
            ...
            <div class="flex flex-col">
                <label class="text-[10px] font-black text-gray-400 mb-1 ml-1 uppercase">Nama Lengkap</label>
            ...
            <div class="flex flex-col">
                <label class="text-[10px] font-black text-gray-400 mb-1 ml-1 uppercase">Email Gmail</label>
                <input type="email" name="email" value="{{ old('email') }}" placeholder="guru@gmail.com" class="p-3.5 rounded-2xl border-none shadow-sm text-sm font-bold focus:ring-2 focus:ring-red-500 transition" required>
            </div>
            <div class="flex flex-col">
                <label class="text-[10px] font-black text-gray-400 mb-1 ml-1 uppercase">Nomor HP/WA</label>
            ...
            <div class="flex flex-col">
                <label class="text-[10px] font-black text-gray-400 mb-1 ml-1 uppercase">Kata Sandi</label>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                <thead class="bg-gray-50 text-[10px] font-black uppercase text-gray-400 tracking-widest">
                    <tr>
                        <th class="p-5 border-b">Nama Tenaga Pendidik</th>
                        <th class="p-5 border-b">Alamat Email</th>
                        <th class="p-5 border-b">Kontak WA</th>
                        <th class="p-5 border-b text-center">Tindakan</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition">
                        ...
                        <td class="p-5 text-center">
                            <form action="{{ route('admin.manajemen-pengajar.destroy', $t->usersID) }}" method="POST">
                                @csrf @method('DELETE')
                                <button type="submit" class="bg-red-50 text-red-600 p-2.5 rounded-xl hover:bg-red-600 hover:text-white transition shadow-sm" onclick="return confirm('Hapus akun pengajar ini?')">
                    ...
                    <tr>
                        <td colspan="4" class="p-20 text-center text-gray-300 font-bold uppercase text-[10px] tracking-widest italic">
                            Belum ada akun pengajar yang terdaftar
                        </td>
                    </tr>
                    @endforelse
                </tbody>
