...
class AuthService {
  ...
  // 5. LENGKAPI PROFIL (Sinkron dengan alamat, wa_ortu, nisn, dob di Controller)
  ...
  // 6. AMBIL KONTEN MATERI (Respons sekarang berisi 'practice_questions')
  ...
  // 13. AMBIL SOAL TRYOUT (Menggunakan tryout_id)
  ...
  // 14. SUBMIT TRYOUT (Respons ID sekarang adalah 'result_id')
