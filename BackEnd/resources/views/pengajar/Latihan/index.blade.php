...
@section('title', 'Select Class - Practice Question')

@section('content')
<div class="bg-white p-8 rounded-3xl shadow-md border-t-8 border-[#990000]">
    <div class="mb-8">
        <h3 class="text-2xl font-black uppercase text-gray-800 tracking-tight">Select Practice Program</h3>
        <p class="text-sm text-gray-500 font-medium">Please select a class to manage the question bank (CSV).</p>
    </div>
        ...
        @forelse($classes as $c)
            <div class="group relative bg-gray-50 rounded-3xl border border-gray-100 overflow-hidden hover:shadow-2xl transition duration-500">
                ...
                <div class="p-6">
                    ...
                    {{-- MODIFIKASI: class_id --}}
                    <a href="{{ route('pengajar.latihan.pilih', $c->class_id) }}"
