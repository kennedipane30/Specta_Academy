        ...
        <div class="dt-hero-content">
            ...
            <div class="dt-hero-tags">
                ...
                <span>
                    ...
                    {{ number_format($confirmedRequests) }} Confirmed
                </span>

                <span>
                    <i class="fa-solid fa-calendar-day"></i>
                    {{ number_format($todayRequests) }} Hari Ini
                </span>
            </div>
        </div>
        ...
        <div class="dt-request-panel">
            ...
            <div class="dt-request-list">
                @forelse($tutors as $t)
                    ...
                    <article class="dt-request-card {{ $statusClass }}">
                        <div class="dt-request-main">
                            ...
                            <div class="dt-request-info">
                                <div class="dt-request-head">
                                    ...
                                    <span class="dt-status {{ $statusClass }}">
                                        {{ $statusLabel }}
                                    </span>
                                </div>
                                ...
                                <div class="dt-info-grid">
                                    ...
                                    <div>
                                        ...
                                        <span>{{ $formattedDay }}, {{ $formattedTime }} WIB</span>
                                    </div>
                        ...
                        <div class="dt-action-area">
                            @if($t->status === 'pending')
                                <form action="{{ route('admin.tutor.update', $t->dedicated_tutor_id) }}" method="POST" class="dt-approve-form" id="form-approve-{{ $t->dedicated_tutor_id }}">
                                    @csrf
                                ...
                                <div class="dt-action-buttons">
                                    ...
                                    <form action="{{ route('admin.tutor.update', $t->dedicated_tutor_id) }}" method="POST" onsubmit="return confirm('Tolak permintaan tutor ini?')">
                                        @csrf
