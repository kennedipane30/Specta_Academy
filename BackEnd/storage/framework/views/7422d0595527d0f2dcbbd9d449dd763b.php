...
<div class="pm-page">
    ...
    <section class="pm-stats">
        ...
        <div class="pm-stat-card">
            ...
            <p>Promo Aktif</p>
            <h2><?php echo e(number_format($activePromo)); ?></h2>
            <div class="pm-stat-meta">
        ...
        <div class="pm-stat-card">
            ...
            <p>Promo Nonaktif</p>
            <h2><?php echo e(number_format($inactivePromo)); ?></h2>
            <div class="pm-stat-meta">
    ...
    <section class="pm-main-grid">
        ...
        <div class="pm-form-panel" id="promoForm">
            ...
            <form action="<?php echo e(route('admin.promo.store')); ?>" method="POST" class="pm-form">
                <?php echo csrf_field(); ?>
                ...
                <div class="pm-input-group">
                    ...
                    <div>
                        <i class="fa-solid fa-ticket"></i>
                        <input type="text" name="code" value="<?php echo e(old('code')); ?>" placeholder="SPEKTA50" required>
                    </div>
                </div>
                ...
                <div class="pm-input-group">
                    ...
                    <div class="pm-discount-wrap">
                        ...
                        <input type="number" name="discount_value" value="<?php echo e(old('discount_value')); ?>" placeholder="Nilai" required>
                ...
                <div class="pm-input-group">
                    ...
                    <div>
                        ...
                        <input type="number" name="quota" value="<?php echo e(old('quota', 100)); ?>" placeholder="100" min="1" required>
                    </div>
                </div>
            ...
            <div class="pm-side-card">
                ...
                <div class="pm-summary-list">
                    <div>
                        ...
                        <strong><?php echo e(number_format($totalPromo)); ?></strong>
                    </div>

                    <div>
                        <span><i class="dot green"></i>Promo Aktif</span>
                        <strong><?php echo e(number_format($activePromo)); ?></strong>
                    </div>

                    <div>
                        <span><i class="dot orange"></i>Nonaktif</span>
                        <strong><?php echo e(number_format($inactivePromo)); ?></strong>
                    </div>

                    <div>
                        <span><i class="dot blue"></i>Total Kuota</span>
                        <strong><?php echo e(number_format($totalQuota)); ?></strong>
                    </div>
                </div>
            </div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $promos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <article class="pm-promo-card">
                    ...
                    <div class="pm-period-bar">
                        <div class="<?php echo e($isExpired ? 'expired' : 'active'); ?>"></div>
                    </div>

                    <form action="<?php echo e(route('admin.promo.destroy', $row->promotion_id)); ?>" method="POST" onsubmit="return confirm('Hapus promo ini?')">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.spekta', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Windows\Documents\GitHub\Specta_Academy\BackEnd\resources\views/admin/promo/index.blade.php ENDPATH**/ ?>