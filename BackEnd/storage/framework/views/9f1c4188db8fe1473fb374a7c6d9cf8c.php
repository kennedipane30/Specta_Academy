<?php $__env->startSection('title', 'Edit Konten Kelas - Spekta Academy'); ?>
<?php $__env->startSection('subtitle', 'Perbarui informasi program kelas'); ?>
...
<div class="cpf-page">
    ...
    <section class="cpf-hero">
        <div>
            ...
            <p>Update visual dan informasi untuk program: <strong><?php echo e($class->program_name); ?></strong></p>
        </div>
    ...
    <section class="cpf-grid">
        <form action="<?php echo e(route('admin.classes.update', $class->class_id)); ?>" method="POST" enctype="multipart/form-data" class="cpf-form-card">
            <?php echo csrf_field(); ?>
            ...
            <div class="cpf-input-group">
                ...
                <div>
                    ...
                    <input type="text" name="program_name" value="<?php echo e(old('program_name', $class->program_name)); ?>" required>
                </div>
            </div>
            ...
            <div class="cpf-input-group">
                ...
                <div>
                    ...
                    <input type="number" name="price" value="<?php echo e(old('price', $class->price)); ?>" required>
                </div>
            </div>

            <div class="cpf-input-group full">
                <label>Deskripsi Program</label>
                <textarea name="description" rows="7" placeholder="Jelaskan keunggulan kelas ini kepada calon siswa..." required><?php echo e(old('description', $class->description)); ?></textarea>
            </div>
            ...
            <div class="cpf-current-info">
                ...
                <div>
                    <strong><?php echo e($class->program_name); ?></strong>
                    <span>ID Program: <?php echo e($class->class_id); ?></span>
                    <small>Kosongkan file jika tidak ingin mengganti banner lama.</small>
                </div>
            </div>

            <div class="cpf-actions">
                <a href="<?php echo e(route('admin.classes.index')); ?>" class="cpf-cancel">Batal</a>
...
<?php echo $__env->make('layouts.spekta', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Windows\Documents\GitHub\Specta_Academy\BackEnd\resources\views/admin/classes/edit.blade.php ENDPATH**/ ?>