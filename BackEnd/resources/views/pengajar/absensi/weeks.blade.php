...
<div class="abs-page">
    ...
    {{-- ── 1. HEADER MINIMALIS DENGAN PROGRES BAR TEAL MAMPUS ── --}}
    <section class="abs-header">
        <div class="abs-header-left">
            <a href="{{ route('pengajar.absensi.index') }}" class="abs-back-btn">
                <i class="fa-solid fa-arrow-left"></i> Kembali
            </a>
            <span class="abs-breadcrumb-capsule">Weekly Attendance</span>
            <h1>{{ $class->program_name }}</h1>
            <p>Rekapitulasi mingguan untuk bidang ajar <strong style="color: var(--spekta-teal);">{{ $subject }}</strong>.</p>
        </div>
    ...
    {{-- ── 2. CARD MINGGU 1-20 (STYLE GRID KALENDER PREMUM) ── --}}
