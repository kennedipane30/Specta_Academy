...
<head>
    <meta charset="utf-8">
    <title>Rekap Absensi <?php echo e($subject); ?> - Minggu <?php echo e($week); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="pdf-container">
        ...
        <div class="info-card">
            <table class="info-table">
                <tr>
                    ...
                    <td class="info-value"><?php echo e($class->program_name); ?></td>
                    <td class="info-label">PERIODE</td>
                    <td class="info-value"><?php echo e(date('Y')); ?></td>
                </tr>
                <tr>
                    <td class="info-label">MATA PELAJARAN</td>
                    <td class="info-value"><?php echo e($subject); ?></td>
                    <td class="info-label">MINGGU KE-</td>
                    <td class="info-value"><?php echo e($week); ?></td>
                </tr>
                <tr>
                    <td class="info-label">TANGGAL CETAK</td>
                    <td class="info-value"><?php echo e(date('d F Y')); ?></td>
                    <td class="info-label">TOTAL SISWA</td>
                    <td class="info-value"><?php echo e($total); ?> Orang</td>
                </tr>
            </table>
        </div>
                ...
                <tr>
                    <td width="33%">
                        <div class="stat-box stat-hadir">
                            <span class="stat-number"><?php echo e($hadir); ?></span>
                            <span class="stat-label">HADIR</span>
                        </div>
                    </td>
                    <td width="33%">
                        <div class="stat-box stat-izin">
                            <span class="stat-number"><?php echo e($izin); ?></span>
                            <span class="stat-label">IZIN</span>
                        </div>
                    </td>
                    <td width="33%">
                        <div class="stat-box stat-alpa">
                            <span class="stat-number"><?php echo e($alpa); ?></span>
        ...
        <div class="table-wrapper">
            <table class="attendance-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="col-no text-center"><?php echo e(str_pad($index + 1, 2, '0', STR_PAD_LEFT)); ?></td>
                        <td class="col-name"><?php echo e($row->user->name ?? '-'); ?></td>
                        <td class="col-status">
                            <?php if($row->status == 'h'): ?>
                        ...
                        <td class="col-date"><?php echo e($row->date ? date('d/m/Y', strtotime($row->date)) : '-'); ?></td>
                    </tr>
            ...
            <table class="signature-table">
                <tr>
                    ...
                    <td width="50%">
                        <div class="signature-box">
                            <div class="signature-line"></div>
                            <div class="signature-name"><?php echo e(Auth::user()->name ?? 'Pengajar'); ?></div>
        ...
        <div class="page-footer">
            ...
            <?php echo e(date('d/m/Y H:i:s')); ?> WIB
        </div>

    </div>
</body>
</html>
<?php /**PATH C:\Users\Windows\Documents\GitHub\PAAAAA2\BackEnd\resources\views/pengajar/absensi/export-pdf.blade.php ENDPATH**/ ?>