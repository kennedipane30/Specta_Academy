    ...
    <section class="abs-panel">
        <div class="abs-panel-head">
            <div>
                ...
                <p>Total data absensi terverifikasi: <?php echo e($totalData); ?> siswa.</p>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="abs-date-text">
                                    <i class="fa-regular fa-clock"></i> <?php echo e($row->date ? date('d M Y', strtotime($row->date)) : '-'); ?> WIB
                                </span>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.spekta', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\perkuliahan\PA 2 - code\PAAAAA2\BackEnd\resources\views/pengajar/absensi/recap.blade.php ENDPATH**/ ?>