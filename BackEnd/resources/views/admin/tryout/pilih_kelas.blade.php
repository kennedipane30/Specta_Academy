...
<div class="cp-page">
    ...
    {{-- ── 2. SELECTION CARDS GRID (STYLE GEN-Z DENGAN HOVER TERAPUNG) ── --}}
    <div class="cp-grid">
        ...
        <div class="cp-main-card class-card">
            ...
            <h3>{{ $class->program_name }}</h3>
            <p>ID Kelas: #{{ $class->class_id }}</p>
            
            <a href="{{ route('admin.scores.pilih_tryout', $class->class_id) }}" class="cp-primary-btn">
                LIHAT DAFTAR PAKET
            </a>
        </div>
        @endforeach
