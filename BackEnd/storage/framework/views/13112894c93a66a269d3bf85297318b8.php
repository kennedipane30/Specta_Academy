    ...
    <div class="recap-header">
        <div class="recap-header-left">
            <div class="breadcrumb">
                <a href="<?php echo e(route('pengajar.absensi.weeks', [$class->class_id, $subject])); ?>" class="back-link">
                    <i class="fa-solid fa-arrow-left"></i> Kembali
                </a>
                <span class="badge-capsule">ATTENDANCE RECAP</span>
            </div>
            <h1 class="recap-title">Rekap Absensi</h1>
            <p class="recap-subtitle"><?php echo e($class->program_name); ?> • <?php echo e($subject); ?> • Minggu <?php echo e($week); ?></p>
        </div>
    </div>
    ...
    <div class="table-card">
        <div class="table-card-header">
            ...
            <div class="card-badge">
                <i class="fa-solid fa-database"></i> <?php echo e($totalData); ?> Siswa
            </div>
        </div>
                        ...
                        <td class="action-cell">
                            <div class="action-wrapper">
                                ...
                                <div class="action-buttons-group">
                                    ...
                                    <button type="button" class="action-icon delete-icon" title="Hapus Absensi" onclick="confirmDelete(<?php echo e($week); ?>)">
