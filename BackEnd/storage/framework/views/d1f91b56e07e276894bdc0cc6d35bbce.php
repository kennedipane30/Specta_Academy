    ...
    <section class="tm-hero-header" style="background: linear-gradient(135deg, #111827 0%, #1e293b 100%); border-radius: 30px; padding: 40px; color: white; margin-bottom: 30px; position: relative; overflow: hidden;">
        <div style="position: relative; z-index: 2; display: flex; justify-content: space-between; align-items: center;">
            <div style="display: flex; align-items: center; gap: 20px;">
                <a href="<?php echo e(route('admin.tryout.index')); ?>" style="width: 45px; height: 45px; background: rgba(255,255,255,0.1); border-radius: 15px; display: grid; place-items: center; color: white; text-decoration: none; transition: 0.3s;">
                ...
                <div>
                    ...
                    <h1 style="margin: 5px 0 0; font-size: 32px; font-weight: 900; letter-spacing: -1px;"><?php echo e($class->program_name); ?></h1>
                </div>
            </div>
            <div style="text-align: right;">
                <div style="font-size: 42px; font-weight: 900; line-height: 1;"><?php echo e($drafts->count()); ?></div>
        ...
        <?php $__currentLoopData = $drafts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="soal-card">
                <div class="soal-card-header">
                    ...
                    <form action="<?php echo e(route('admin.tryout.draft.delete', $d->id)); ?>" method="POST">
                ...
                <div class="soal-body">
                    ...
                    <div class="options-grid">
                        <?php $__currentLoopData = ['a','b','c','d','e']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $isCorrect = (strtoupper($opt) == strtoupper($d->correct_answer)); ?>
                            <div class="option-item <?php echo e($isCorrect ? 'correct' : ''); ?>">
                                ...
                                <?php if($isCorrect): ?> <i class="fa-solid fa-check-circle check-icon"></i> <?php endif; ?>
                            </div>
...
<?php echo $__env->make('layouts.spekta', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Windows\Documents\GitHub\Specta_Academy\BackEnd\resources\views/admin/tryout/review_drafts.blade.php ENDPATH**/ ?>