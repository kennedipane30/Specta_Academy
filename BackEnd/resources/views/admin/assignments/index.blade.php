...
@section('subtitle', 'Atur relasi pengajar dan mata pelajaran per program')
...
<div class="am-page">
    ...
    <section class="am-hero">
        <div class="am-hero-text">
            ...
            <div class="am-tags">
                ...
                <span><i class="fa-solid fa-book"></i> {{ $coveredSubjects }} Mapel Terisi</span>
                <span><i class="fa-solid fa-school"></i> {{ $assignedClasses }} Program</span>
            </div>
        </div>
    ...
    <section class="am-strip">
        ...
        <div class="am-strip-card"><span>SLOT KOSONG</span><strong>{{ $totalSlots - $totalAssignments }}</strong></div>
    </section>
                                ...
                                <td>
                                    @if($slot)
                                        <div class="am-slot filled">
                                            ...
                                            <span>{{ $slot->teacher->name ?? 'Guru' }}</span>
                                        </div>
                                    @else
    ...
    <section class="am-card">
        ...
        <div class="am-table-list-wrap">
            <table class="am-list-table">
                ...
                <tbody>
                    @forelse($assignmentCollection as $assign)
                        <tr>
                            <td>
                                <div class="am-t-cell">
                            ...
                            <td><span class="badge-subject">{{ $assign->subject->name ?? 'N/A' }}</span></td>
                            <td>
